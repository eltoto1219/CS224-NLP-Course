...
def negSamplingLossAndGradient(
    ...
    for k in range(K):
        ...
        loss -= np.log(1.0-z)
        gradOutsideVecs[samp] += centerWordVec * z
        gradCenterVec  += outsideVectors[samp] * z
...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    windowSize -- intger, context window size
    ...
    gradCenterVecs -- the gradient with respect to the center word vectorsj            (dJ / dV in the pdf handout)
